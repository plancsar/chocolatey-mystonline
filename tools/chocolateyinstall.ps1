...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url           = 'https://account.mystonline.com/download/MOULInstaller.exe'
  url64bit      = $url64
  #file         = $fileLocation

  softwareName  = 'Myst Online Uru Live*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided.
  # You can also use checksum.exe (choco install checksum) and use it
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = '2BB2F6C504D81BEA58ED34ABA26669F88489E1E52D785976CA119310F0848592'
